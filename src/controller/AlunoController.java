...
public class AlunoController implements Initializable{
	    ...
	    @FXML
	    private Button alunosPorNotaBtn;
	    ...
	    @FXML
	    void getAlunosPorNota(ActionEvent event) {
	    	AlunoDAO dao = new AlunoDAO();
	    	List<String> alunos = dao.getAlunosPorNota();
	    	String lista = "Alunos por Nota: \n";
	    	for(int x = 0; x <alunos.size(); x+=2) {
	    		lista+= "\t" + alunos.get(x) + "\n" + "\t" + alunos.get(x+1) + "\n";
	    	}
	    	Alert alert;
        	alert = new Alert(AlertType.INFORMATION, lista, ButtonType.OK);
    		alert.setTitle("Lista de Alunos");
    		alert.setHeaderText("A lista mostra aluno por nota");
        	alert.show();
	    }
